...
def hent_plaader_fra_bilopslag():
    ...
    print(f"\n🎯 Bilopslag fandt i alt {len(plader_og_stel)} gyldige plader med stelnummer.")
...
async def check_new_registrations():
    ...
    if new_plates:
        ...
        print(f"[INFO] Bilopslag: Fundet og behandlet {len(new_plates)} nye plader.")
    else:
        print("[INFO] Bilopslag: Ingen nye plader at gemme.")
